...
<div class="page-bar">
  <ul class="page-breadcrumb">
      ...
      <li>
          <span>{!! trans('labels.breadcrumb.articleCategoryList') !!}</span>
      </li>
  </ul>
</div>
<!-- END PAGE BAR -->
        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
          <div class="portlet-title">
            <div class="caption">
              ...
              <span class="caption-subject font-dark sbold uppercase">{{trans('labels.article_category.list')}}</span>
            </div>
              <div class="actions">
                  <div class="btn-group">
                      @permission('admin.article.categorycreate')
                      <a href="{{url('admin/articleCategory/create')}}" class="btn btn-success btn-outline btn-circle">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    <thead>
                        <tr role="row" class="heading">
                          <th>#</th>
                          <th > {{ trans('labels.article_category.name') }} </th>
                            ...
                            <td>
                              <div class="form-group form-md-line-input">
                                <div class="input-group has-success">
                                    ...
                                    <input type="text" class="form-control form-filter" name="name" placeholder="{{ trans('labels.article_category.name') }}">
...
<script type="text/javascript" src="{{asset('backend/js/article/category.js')}}"></script>
